...
test_that("load_course_file works as expected", {
  ...
  expect_that(load_course_file(), throws_error())
  ...
  expect_that(course$chapters$chapter1.Rmd, equals(1))
  expect_that(names(course$chapters)[2], equals("chapter2.Rmd"))
  expect_that(course$chapters$chapter2.Rmd, equals(2))
...
test_that("add_id_to_course_file works as expected", {
  ...
  expect_that(add_id_to_course_file(2), throws_error())
...
test_that("get_chapter_index works as expeced", {
  ...
  write("testchapter2", file = "chapter2.Rmd")
  write("title: test\nauthor_field: testauthor\ndescription: testdescription\nchapters:\n- chapter1.Rmd: 1\n- chapter2.Rmd: 2\n", file = "course.yml")
  expect_that(get_chapter_index("chapter1.Rmd"), equals(1))
  expect_that(get_chapter_index("chapter2.Rmd"), equals(2))
  expect_that(length(get_chapter_index("chapter3.Rmd")), equals(0))
...
test_that("add_chapter_to_course_file works as expeced", {
  ...
  expect_that(is.null(add_chapter_to_course_file("chapter1.Rmd",5)), is_true())
  
  # not yet in there
  write("testchapter3", file = "chapter3.Rmd")
  expect_that(add_chapter_to_course_file("chapter3.Rmd",3), shows_message())
  course = load_course_file()
  expect_that(names(course$chapters)[3], equals("chapter3.Rmd"))
  expect_that(course$chapters$chapter3.Rmd, equals(3))
